...
export const PROVIDERS: Record<string, ProviderConfig> = {
  'z.ai': {
    ...
    models: [
      ...
      { id: 'glm-4.5-air', name: 'GLM-4.5 Air', description: 'Lightweight model for simple tasks' },
      { id: 'glm-4.7-flash', name: 'GLM-4.7 Flash', description: 'Fast, lightweight GLM-4.7' },
    ],
  ...
  'minimax': {
    ...
    models: [
      ...
      { id: 'MiniMax-M2.5', name: 'MiniMax M2.5', description: 'Previous generation' },
    ],
  ...
  'google': {
    ...
    models: [
      ...
      { id: 'gemini-3-flash-preview', name: 'Gemini 3 Flash Preview', description: 'Pro-level intelligence at Flash speed' },
      { id: 'gemini-3.1-flash-lite-preview', name: 'Gemini 3.1 Flash Lite Preview', description: 'Cost-efficient, high-volume tasks' },
