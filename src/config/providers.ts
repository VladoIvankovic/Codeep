...
export const PROVIDERS: Record<string, ProviderConfig> = {
  'z.ai': {
    ...
    models: [
      { id: 'glm-5', name: 'GLM-5', description: 'Most capable GLM model (Pro/Max plan only, not Lite)' },
      { id: 'glm-5-turbo', name: 'GLM-5 Turbo', description: 'Faster GLM-5 variant (Pro/Max plan only, not Lite)' },
